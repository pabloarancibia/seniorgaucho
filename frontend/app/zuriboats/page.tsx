...
export default function ZuriboatsPage() {
  ...
  if (!isSynced) {
    return (
      <div className="mx-auto flex h-[calc(100vh-4rem)] max-w-lg flex-col items-center justify-center gap-4 px-4 text-center">
  ...
  return <iframe src="/zuriboats-docs/index.html" title="Zuriboats" className="h-[calc(100vh-4rem)] w-full border-0" />;
}
